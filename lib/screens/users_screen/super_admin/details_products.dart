...
class _ProductsDetilsScreenState extends State<ProductsDetailsScreen> {
  ...
  StreamBuilder<QuerySnapshot<Object?>> itemProducts() {
          ...
          child: ListView(
            ...
            children: snapshot.data!.docs.map(
              (
                ...
                if (_nameController.text.contains(firstTenCharacters)) {
                  return itemProduct(data, fech, documentId, horas, context);
                }
